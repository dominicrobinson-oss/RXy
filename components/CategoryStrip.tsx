				...
				<div className="mx-auto inline-flex w-max min-w-full items-center justify-start gap-3 md:grid md:w-full md:min-w-0 md:grid-cols-6 md:gap-4">
					{categories.map((category) => (
						<button
							key={category}
							type="button"
							className="rounded-lg bg-[#005462] px-7 py-4 text-lg font-bold uppercase tracking-[0.03em] text-white transition hover:bg-[#064653] md:w-full md:px-4 md:py-3.5 md:text-[17px]"
						>
							{category}
						</button>
					))}
