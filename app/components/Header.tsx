    ...
    <div className="bg-white">
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
        <div className="flex items-center gap-3 md:gap-6 min-w-0">
          <div className="font-black tracking-widest text-xl md:text-3xl text-[#0b4b59] min-w-fit">
            RXy+
          </div>

          <div className="hidden md:flex items-center gap-2">
            <button className="px-5 py-2 rounded-full border border-orange-500 text-[#0b4b59] text-[15px] font-semibold">
              NUTRITION
            </button>
            <button className="px-4 py-2 text-[#0b4b59] text-[15px] font-semibold hover:text-black transition">
              CLOTHING
            </button>
            <button className="px-4 py-2 text-[#0b4b59] text-[15px] font-semibold hover:text-black transition">
              BRANDS
